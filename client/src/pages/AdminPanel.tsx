                      ...
                      <tbody className="bg-white divide-y divide-gray-200">
                        {filteredUsers.map((user: any) => (
                          <tr key={user.id}>
                            ...
                            <td className="px-6 py-4 whitespace-nowrap">
                              <Badge
                                variant={user.userType === 'host' ? "default" : "secondary"}
                                className={
            ...
            <Card>
              ...
              <CardContent>
                <div className="text-center py-8">
                  ...
                  <p className="text-gray-600">Property management features will be available here</p>
                </div>
              </CardContent>
            </Card>
          </TabsContent>
            ...
            <Card>
              ...
              <CardContent>
                <div className="text-center py-8">
                  ...
                  <p className="text-gray-600">Booking management features will be available here</p>
                </div>
              </CardContent>
            </Card>
          </TabsContent>
